...
export tools=acl20.tool
export test_tgt_raw=acl20.tool/valid/valid.raw.zh
export reverse=
# task name
export task=ja2zh
...
for ((i=0;i<${#whos[@]};i++));do
{
	...
	python $tools/postedit.py -i zh < $save_dir/$who.tok.hyp > $save_dir/$who.post.char.hyp
